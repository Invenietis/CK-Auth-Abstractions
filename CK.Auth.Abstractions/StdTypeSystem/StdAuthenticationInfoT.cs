...
namespace CK.Auth
{
        ...
        where TThis : StdAuthenticationInfo<TUserInfo,TThis>
    {
        ...
        readonly IUserInfoType<TUserInfo> _userInfoType;
        ...
        public StdAuthenticationInfo(
            IUserInfoType<TUserInfo> userInfoType,
        ...
        /// </summary>
        protected IUserInfoType<TUserInfo> UserInfoType => _userInfoType;

        IAuthenticationInfo<TUserInfo> IAuthenticationInfo<TUserInfo>.ClearImpersonation( DateTime utcNow ) => ClearImpersonation( utcNow );
        ...
        IAuthenticationInfo<TUserInfo> IAuthenticationInfo<TUserInfo>.CheckExpiration( DateTime utcNow ) => CheckExpiration( utcNow );

        IAuthenticationInfo<TUserInfo> IAuthenticationInfo<TUserInfo>.SetExpires( DateTime? expires, DateTime utcNow ) => SetExpires( expires, utcNow );

        IAuthenticationInfo<TUserInfo> IAuthenticationInfo<TUserInfo>.SetCriticalExpires( DateTime? criticalExpires, DateTime utcNow ) => SetCriticalExpires( criticalExpires, utcNow );
